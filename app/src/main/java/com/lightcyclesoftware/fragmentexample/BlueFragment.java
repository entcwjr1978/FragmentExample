 ...
 * {@link BlueFragment.OnBlueFragmentInteractionListener} interface
...
public class BlueFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onBlueFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnBlueFragmentInteractionListener) activity;
